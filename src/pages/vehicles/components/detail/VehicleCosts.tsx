...
const VehicleCosts: React.FC<VehicleCostsProps> = ({ vehicle, config, oneTimeCosts }) => {
  // Bestimme, ob es sich um einen Firmenwagen handelt, basierend auf der Fahrzeugkategorie.
  // Wenn vehicle.category "company" ist oder in den categories "company" enthalten ist,
  // wird "zzgl. MwSt." angezeigt, andernfalls "inkl. MwSt." für Privatwagen.
  const isCompanyVehicle = vehicle.category === 'company' || vehicle.categories?.includes('company');
  ...
  return (
    <div className="space-y-8">
      <div className="bg-white rounded-lg shadow divide-y divide-gray-200">
              ...
              <div className="mt-4 flex items-start justify-between">
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-500 mt-2">
                    {isCompanyVehicle ? 'zzgl. MwSt.' : 'inkl. MwSt.'}
                  </span>
                </div>
        ...
        <div className="p-6">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Einmalige Kosten gesamt</h3>
            {/* Individual Costs */}
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                    <div className="space-y-2 flex-1">
                      <div className="font-medium text-gray-900">
                        {cost.name}
                        {cost.isInclusive && (
                          <span className="ml-2 text-sm text-green-600 font-normal">(inklusive)</span>
                        )}
                      </div>
                      {cost.description && (
