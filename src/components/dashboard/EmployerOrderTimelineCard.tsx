...
const EmployerOrderTimelineCard: React.FC = () => {
  const { user } = useAuthStore();
  const { orders, loading } = useOrders(user?.companyId);
    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-bold text-gray-800">Aktuelle Bestellung</h2>
        </div>
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          {latestOrder.employee && (
            <p className="text-sm text-gray-500">
              Mitarbeiter: {latestOrder.employee.firstName} {latestOrder.employee.lastName}
            </p>
          )}
          <p className="text-sm text-gray-500">
...
export default EmployerOrderTimelineCard;
